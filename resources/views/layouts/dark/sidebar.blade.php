      ...
      <div class="main-navbar">
         ...
         <div id="mainnav">
            <ul class="nav-menu custom-scrollbar">
               ...
               <li class="dropdown">
                  <a class="nav-link menu-title {{request()->route()->getPrefix() == '/starter-kit' ? 'active' : '' }}" href="#"><i data-feather="anchor"></i><span>Sarter Kit</span>
                  ...
                  <ul class="nav-submenu menu-content" style="display: {{request()->route()->getPrefix() == '/starter-kit' ? 'block;' : 'none' }}">
                     <li>
                        <a class="submenu-title {{ in_array(Route::currentRouteName(), ['layout-light', 'layout-dark']) ? 'active' : '' }}" href="#">Color Version
                           <div class="according-menu"><i class="fa fa-angle-double-{{ in_array(Route::currentRouteName(), ['layout-light', 'layout-dark']) ? 'down' : 'right' }}"></i></div>
                        </a>
                        <ul class="nav-sub-childmenu submenu-content" style="display: {{ in_array(Route::currentRouteName(), ['layout-light', 'layout-dark']) ? 'block' : 'none' }};">
                           ...
                           <li><a href="{{route('layout-dark')}}" class="{{ Route::currentRouteName()=='layout-dark' ? 'active' : '' }}" style=" {{ Route::currentRouteName()=='layout-dark' ? 'font-weight: bold;' : '' }}"><b>Layout Dark</b></a></li>
                        </ul>
                     </li>
                     <li>
                        <a class="submenu-title {{ in_array(Route::currentRouteName(), ['layout-box', 'layout-rtl', 'compact-layout', 'vertical-layout', 'dark-rtl-layout', 'vertical-rtl-layout', 'compact-rtl-layout', 'dark-box-layout', 'vertical-box-layout', 'compact-dark-layout']) ? 'active' : '' }}" href="#">Page layout
                           <div class="according-menu"><i class="fa fa-angle-double-{{ in_array(Route::currentRouteName(), ['layout-box', 'layout-rtl', 'compact-layout', 'vertical-layout', 'dark-rtl-layout','vertical-rtl-layout', 'compact-rtl-layout', 'dark-box-layout', 'vertical-box-layout', 'compact-dark-layout']) ? 'down' : 'right' }}"></i></div>
                        </a>
                     ...
                     <li>
                        <a class="submenu-title {{ in_array(Route::currentRouteName(), ['footer-light', 'footer-dark', 'footer-fixed']) ? 'active' : '' }}" href="#">Footers
                           <div class="according-menu"><i class="fa fa-angle-double-{{ in_array(Route::currentRouteName(), ['footer-light', 'footer-dark', 'footer-fixed']) ? 'down' : 'right' }}"></i></div>
                        </a>
